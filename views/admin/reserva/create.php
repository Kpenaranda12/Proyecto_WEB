...
<?php
echo form_open_multipart('administracion/Reservas/create');
?>
<!--Clase de Bootstrap -->
<br>
...
foreach ($reservas as $reserva):
    ...
    $fecha_dev = $reserva['fecha_de_devolucion'];
            ...
            ?>
					...
					<td>
				       <a class="btn btn-outline-info" href="<?php echo base_url('administracion/Reservas/devolverPago/' . $reserva['id_reserv'] . '/' . $reserva['libro_id']); ?>">Pagar y Devolver</a>
            ...
            ?>
					...
					<td>
					     <a class="btn btn-outline-info" href="<?php echo base_url('administracion/Reservas/devolver/' . $reserva['id_reserv'] . '/' . $reserva['libro_id']); ?>">Devolver</a>
					</td>
					          <?php
    }
        ?>
